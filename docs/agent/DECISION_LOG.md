...
| 2026-06-07 | Use Cloudflare Tunnel for public MVP URL | Vercel CLI rejected token and REST deploy lacked project-create permission | Wait for Vercel permission fix |
